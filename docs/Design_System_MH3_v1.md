...
- **Denver-Blau** = Marcus-Perspektive: Quotes, Praxis-Karten (Denver-Blau-Leiste), OfferCards (Border-Top), Prozessschritte, Footer-Trennlinie
...
Nicht zwischen allen Sections — nur wo ein thematischer Wechsel stattfindet.
...
| Kontakt | bestehend | Shared Component |

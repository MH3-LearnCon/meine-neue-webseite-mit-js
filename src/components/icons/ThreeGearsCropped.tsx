/**
 * Drei ineinandergreifende Zahnräder – angeschnitten/quadratisch.
 * Quelle: public/images/gears/01_3_Zahnraeder_angeschnitten.svg
 * Farbe über `currentColor` steuerbar.
 */

interface ThreeGearsCroppedProps {
  width?: number | string;
  height?: number | string;
  className?: string;
}

/** Wiederverwendbarer Zahnrad-Pfad (Kontur) */
...
/** Wiederverwendbarer Zahnrad-Pfad (Füllung linke Hälfte) */
...
function GearUnit({ outlineId, fillId, groupTransform }: { outlineId: string; fillId: string; groupTransform: string }) {
  return (
...
export default function ThreeGearsCropped({
  width = 120,
  height = 120,
  className = "text-orange",
}: ThreeGearsCroppedProps) {
  return (
    <svg
      width={width}
      height={height}
    ...
    >
      <g transform="matrix(1.26864,0,0,1.26864,-0.178313,0.26826)">
        <g transform="matrix(0.786493,0,0,0.788834,1.54167,2.10051)">
          <clipPath id="threeGearsCropClip">
            <rect x="-1.781" y="-2.931" width="1082.41" height="1079.2" />
          </clipPath>
          <g clipPath="url(#threeGearsCropClip)">
            <g transform="matrix(1.27147,0,0,1.26769,-1.96019,-2.6628)">
              <GearUnit
                outlineId="g1o"
                fillId="g1f"
                groupTransform="matrix(0.948282,0,0,0.948282,-37.2326,-98.7048)"
              />
              <GearUnit
                outlineId="g2o"
                fillId="g2f"
                groupTransform="matrix(0.372236,-0.87217,0.87217,0.372236,434.549,104.556)"
              />
              <GearUnit
                outlineId="g3o"
                fillId="g3f"
                groupTransform="matrix(0.361681,0.876599,-0.876599,0.361681,997.14,367.022)"
              />
            </g>
          </g>
        </g>

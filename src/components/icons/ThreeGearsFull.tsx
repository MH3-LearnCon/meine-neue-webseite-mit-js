/**
 * Drei ineinandergreifende Zahnräder – vollständig sichtbar (Hochformat).
 * Quelle: public/images/gears/02_3_Zahnraeder_vollstaendig.svg
 * Farbe über `currentColor` steuerbar.
 */

interface ThreeGearsFullProps {
  width?: number | string;
...
export default function ThreeGearsFull({
  width = 80,
  height = 104,
  ...
  return (
    ...
    >
      <g transform="matrix(1,0,0,1,40.594,641.531)">

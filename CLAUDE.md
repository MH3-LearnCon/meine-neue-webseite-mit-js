...
- `src/app/angebote/pitch-workshop/page.tsx` → `content/Pitch_Workshop_Texte_MH3_v1.md`
...
- `src/app/newsletter-bestaetigt/page.tsx` → `content/Newsletter_Bestaetigt_Texte_MH3_v1.md`
